...
public class VisualizadorImagem extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pnx_imagem, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        setBounds((screenSize.width-683)/2, (screenSize.height-595)/2, 683, 595);
    ...
    private void salvar() {
        ...
        if (retorno == JFileChooser.APPROVE_OPTION) {
            ...
            if(DiretorioUtil.verificarSeArquivoDiretorioExiste(file)){
                ...
                InstanciasPortatil.getMensagens().sucesso(MensagensSoltas.comumImagemSalvar());
            }
        }
    }
