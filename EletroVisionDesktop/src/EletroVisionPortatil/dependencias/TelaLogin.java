...
public class TelaLogin extends javax.swing.JDialog {
    ...
    public TelaLogin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        InstanciasPortatil.setTelaLogin(this);
    }
    ...
    public void confirmaConexao(String confirmacao) {
        ...
        switch (confirmacao) {
            case "0":
                ...
                InstanciasPortatil.getMensagens().bug(MensagensSoltas.loginInvalido());
                break;
            case "1":
                InstanciasPortatil.getMensagens().sucesso(MensagensSoltas.portatilConexaoSucesso());
            ...
            case "2":
                cliente.fecharConexao();
                InstanciasPortatil.getMensagens().aviso(MensagensSoltas.portatilUsuarioLogado());
                break;
        }
    }
