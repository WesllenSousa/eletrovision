...
import EletroVisionPortatil.dependencias.TelaLogin;
...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    public TelaPrincipal() {
        ...
        if(InstanciasPortatil.getCliente() == null) {
            ...
            mi_conectar.setText("Desconectar");
        }
    }
    ...
    private void initComponents() {
        ...
        bt_mensagem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/imagens/aplicacaoPortatil/mensagens_36.png"))); // NOI18N
        ...
        bt_cenario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/imagens/aplicacaoPortatil/cenario_36.png"))); // NOI18N
        ...
        bt_camera.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/imagens/aplicacaoPortatil/camera_36.png"))); // NOI18N
        ...
        bt_dispositivos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/imagens/aplicacaoPortatil/dispositivo_36.png"))); // NOI18N
        ...
        bt_ultimaFoto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/imagens/aplicacaoPortatil/ultima_foto_36.png"))); // NOI18N
    ...
    private JPanel manipulaItemMenu(JToggleButton tb, JPanel painel){
        if(tb.isSelected()){
            ...
            if(tb.getName().equals("Mensagens")) {
                InstanciasPortatil.setTelaMensagens(null);
            } else if(tb.getName().equals("Dispositivos")) {
    ...
    private void conectar() {
        if(InstanciasPortatil.getCliente() == null) {
            ...
            if(InstanciasPortatil.getMensagens().confirmacao(MensagensSoltas.portatilDesconectarConfirmar())) {
