...
public class FaceBundle implements Serializable {
     ...
     * Calculate the weights for the chosen subset of eigenfaces. The weights
     * can be thought of as the rotated image coordinates so the eigenfaces
     * (eigenvectors) becomes axes.
     */ {
