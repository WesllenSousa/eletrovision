 ...
 */
public class DetectarBaixoCorpo implements Runnable{
    ...
    public DetectarBaixoCorpo(IplImage img, ServidorCamera c_camera){
        this.img = img;
    ...
    public void detectar() throws Exception{
        ...
        CvHaarClassifierCascade cascade = new CvHaarClassifierCascade(cvLoad(ArquivosScripts.cascadeBaixoCorpo()));
        if (cascade.isNull()) {
            System.out.println("Não foi possível carregar o cascade: haarcascade_lowerbody.xml");
        }
    ...
    private void reportarCorpo() {
        System.out.println("Total de BaixoCorpos: "+totalCorpo);
