 ...
 */
public class DetectarAutoCorpo implements Runnable{
    ...
    public DetectarAutoCorpo(IplImage img, ServidorCamera c_camera){
        this.img = img;
    ...
    public void detectar() throws Exception{
        ...
        CvHaarClassifierCascade cascade = new CvHaarClassifierCascade(cvLoad(ArquivosScripts.cascadeAutoCorpo()));
        if (cascade.isNull()) System.out.println("Não foi possível carregar o cascade: haarcascade_upperbody.xml");
    ...
    private void reportarCorpo() {
        System.out.println("Total de AutoCorpos: "+totalCorpo);
