...
public class RelatorioJasper {
     ...
     */
    public RelatorioJasper(ConexaoJDBC conn, HashMap parameters, URL localRelatorio) throws JRException{
     ...
     * algum problema com ele, uma exceção é gerada.
     */
    public RelatorioJasper(ConexaoJDBC conn, HashMap parameters, String localRelatorio) throws JRException{
     ...
     */
    public RelatorioJasper(ConexaoJDBC conn, String sql,
     ...
     * algum problema com ele, uma exceção é gerada.
     */
    public RelatorioJasper(HashMap parameters, URL localRelatorio) throws JRException {
     ...
     * algum problema com ele, uma exceção é gerada.
     */
    public RelatorioJasper(HashMap parameters, String localRelatorio) throws JRException {
