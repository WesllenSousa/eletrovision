...
import telas.dependencias.DispositivoTableModel;
...
public class TelaDispositivos extends javax.swing.JPanel {
    ...
    public void confirmacao(String confirmacao) {
        ...
        switch (confirmacao) {
            case "0":
                InstanciasPortatil.getMensagens().bug("Erro ao ativar o dispositivo!");
                break;
            case "1":
                InstanciasPortatil.getMensagens().sucesso("Dispositivo ativo com sucesso!");
                break;
            case "2":
                InstanciasPortatil.getMensagens().aviso("Acionamento desativado!");
                break;
        }
    }
