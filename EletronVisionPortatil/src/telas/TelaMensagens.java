...
import telas.dependencias.ExibirListaMensagem;
...
public class TelaMensagens extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursos/imagens/enviar_36.png"))); // NOI18N
    ...
    private void enviar() {
        if (InstanciasPortatil.getCliente() != null) {
            ...
            InstanciasPortatil.getMensagens().sucesso("Mensagem enviada com sucesso!");
        } else {
