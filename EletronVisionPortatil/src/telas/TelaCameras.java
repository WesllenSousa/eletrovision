...
import telas.dependencias.CameraTableModel;
...
public class TelaCameras extends javax.swing.JPanel {
    ...
    public void confirmacao(String confirmacao) {
        ...
        switch (confirmacao) {
            case "0":
                InstanciasPortatil.getMensagens().aviso("As câmeras estão desligadas!");
                break;
            case "2":
                InstanciasPortatil.getMensagens().aviso("Câmera desativada!");
                break;
        }
    }
