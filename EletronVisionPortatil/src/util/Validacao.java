...
public class Validacao {
    ...
    public static boolean verificaStringVazia(String v) {
    ...
    public static boolean verificaNumeroNegativo(String v) {
    ...
    public static boolean verificaNumeroInteger(String v) {
        try {
            Integer.parseInt(v);
    ...
    public static boolean verificaNumeroFloat(String v) {
        try {
            Float.parseFloat(v);
        } catch (NumberFormatException e) {
            return false;
    ...
    public static boolean verificaNumeroDouble(String v) {
        try {
    ...
    public static boolean verificaIP(String v) {
    ...
    public static boolean verificaData(String data) {
        if (DataUtil.formataData(data) != null) {
            return true;
        }
        return false;
    }
    ...
    public static boolean verificaCnpj(String str_cnpj) {
        int soma = 0, dig;
