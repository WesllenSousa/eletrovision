...
public class ImagemUtil {
    ...
    public static BufferedImage ler(String arquivo) {
        try {
            ...
            InstanciasPortatil.getMensagens().bug("ImagemUtil: \n" + e);
        }
        return null;
    }
    ...
    public static BufferedImage ler(InputStream input) {
        try {
            ...
            InstanciasPortatil.getMensagens().bug("ImagemUtil: ler\n" + e);
        }
        return null;
    }
    ...
    public static void salvar(BufferedImage bufferedImage, String sufixo, String arquivo) {
        try {
            ...
            InstanciasPortatil.getMensagens().bug("ImagemUtil: salvar\n" + e);
        }
    }
    ...
    public static byte[] imagemParaByte(String arquivo) {
        ...
        try {
            ...
            InstanciasPortatil.getMensagens().bug("ImagemUtil - imagemParaByte: \n"+ex);
        } finally {
            try {
    ...
    public void receberSalvarImagemRede(ObjectInputStream entrada, String arquivo) {
        ...
        try {
            ...
            InstanciasPortatil.getMensagens().bug("Erro" + ex);
        } finally {
            try {
                file.close();
            } catch (IOException ex) {
